...
class WrapperModel(pl.LightningModule):
    def __init__(self,
        ...
        self.train_generated_operator_accuracy = torchmetrics.Accuracy(task="multiclass",
                                                       num_classes=len(operator_ids))
        ...
        self.validation_operator_accuracy = torchmetrics.Accuracy(task="multiclass",
                                                             num_classes=len(operator_ids))
        self.validation_generated_operator_accuracy = torchmetrics.Accuracy(task="multiclass",
                                                                       num_classes=len(operator_ids))
        ...
        self.test_operator_accuracy = torchmetrics.Accuracy(task="multiclass",
                                                                  num_classes=len(operator_ids))
        self.test_generated_operator_accuracy = torchmetrics.Accuracy(task="multiclass",
                                                                            num_classes=len(operator_ids))
